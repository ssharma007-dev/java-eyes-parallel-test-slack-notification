...
var require_general = __commonJS({
  "../utils/dist/general.js"(exports) {
    ...
    function cachify2(func, getKey, TTL = 2 * 60 * 60 * 1e3) {
      const cache = /* @__PURE__ */ new Map();
      const cacheTimeouts = /* @__PURE__ */ new Map();
      caches.push(cache);
      const funcWithCache = (...args) => {
        ...
        if (!value || cacheTimeouts.has(key) && cacheTimeouts.get(key) <= Date.now()) {
          value = func(...args);
          cache.set(key, value);
          cacheTimeouts.set(key, Date.now() + TTL);
        }
        return value;
      };
...
async function req(input, ...requestOptions) {
  ...
  async function buildRequest(input2, opts, requestController) {
    ...
    const url = new URL(String((_a4 = input2.url) !== null && _a4 !== void 0 ? _a4 : input2), opts.baseUrl);
    if (opts.query) {
    ...
    const extraHeaders = {};
    if (utils3.types.isPlainObject(opts.body) || utils3.types.isArray(opts.body) || opts.body === null) {
    ...
    let request = new Request(url, {
      ...
      headers: {
        ...extraHeaders,
        ...Object.fromEntries((_d2 = (_c = input2.headers) === null || _c === void 0 ? void 0 : _c.entries()) !== null && _d2 !== void 0 ? _d2 : []),
  ...
  async function tryFallback(request, response, opts, optionsFallbacks) {
    ...
    const fallbackOptions = shouldFallback && await ((_a4 = fallbackStrategy === null || fallbackStrategy === void 0 ? void 0 : fallbackStrategy.updateOptions) === null || _a4 === void 0 ? void 0 : _a4.call(fallbackStrategy, {
  ...
  async function findApplicableRetry(opts, context) {
    ...
    if (context.response) {
      return await retries.reduce(async (prev, retry) => {
        ...
        return result !== null && result !== void 0 ? result : (((_a4 = retry.statuses) === null || _a4 === void 0 ? void 0 : _a4.includes(context.response.status)) || await ((_b = retry.validate) === null || _b === void 0 ? void 0 : _b.call(retry, { response: context.response }))) && (!retry.limit || !retry.attempt || retry.attempt < retry.limit) ? retry : null;
    ...
    if (context.error) {
      return await retries.reduce((prev, retry) => {
        return prev.then(async (result) => {
          var _a4, _b;
          return (result !== null && result !== void 0 ? result : (((_a4 = retry.codes) === null || _a4 === void 0 ? void 0 : _a4.includes(context.error.code)) || await ((_b = retry.validate) === null || _b === void 0 ? void 0 : _b.call(retry, { error: context.error }))) && (!retry.limit || !retry.attempt || retry.attempt < retry.limit)) ? retry : null;
        });
      }, Promise.resolve(null));
    }
    return null;
  ...
  function calculateRetryDelay(retry, response) {
    ...
    if (utils3.types.isArray(retry.timeout)) {
      return retry.timeout[Math.min((_a4 = retry.attempt) !== null && _a4 !== void 0 ? _a4 : 0, retry.timeout.length - 1)];
    }
  ...
  async function handleRetry(request, retry, context, opts) {
    var _a4;
    (_a4 = retry.attempt) !== null && _a4 !== void 0 ? _a4 : retry.attempt = 0;
